...
from sqlalchemy import CheckConstraint, Decimal as SADecimal, ForeignKey, Index, UniqueConstraint
...
class DetalleExpensa(Base):
    ...
    indice: Mapped[Decimal] = mapped_column(SADecimal(5, 2), nullable=False)
    monto_ordinario: Mapped[Decimal] = mapped_column(SADecimal(12, 2), nullable=False)
    ...
    total: Mapped[Decimal] = mapped_column(SADecimal(12, 2), nullable=False)
